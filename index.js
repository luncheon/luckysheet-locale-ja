export default {
  ...
  toolbar: {
    ...
    borderStyle: "罫線のスタイル",
    mergeCell: "セルの結合",
    chooseMergeType: "セルの結合",
    horizontalAlign: "水平方向の配置",
    verticalAlign: "垂直方向の配置",
    alignment: "配置",
    textWrap: "文字の折り返し",
    textWrapMode: "文字の折り返し",
    textRotate: "文字の回転",
    textRotateMode: "文字の回転",
    freezeTopRow: "先頭行の固定",
  ...
  alternatingColors: {
    ...
    errorInfo: "この操作は複数の選択範囲に対して実行できません。",
    textTitle: "書式スタイル",
    custom: "カスタム",
    close: "閉じる",
    selectionTextColor: "クリックしてテキストの色を選択",
    selectionCellColor: "クリックして塗りつぶしの色を選択",
    removeColor: "縞模様を削除",
    colorShow: "色",
    currentColor: "現在の色",

    tipSelectRange: "縞模様の適用範囲を選択してください。",
    errorNoRange: "適用範囲が選択されていません。",
    errorExistColors: "すでに縞模様が適用されています。",
  },
  button: {
    confirm: "OK",
    cancel: "キャンセル",
  ...
  info: {
    ...
    tipInputNumberLimit: "1 以上 100 以下の数値を入力してください",

    tipRowHeightLimit: "0 以上 545 以下の数値を入力してください",
    tipColumnWidthLimit: "0 以上 2038 以下の数値を入力してください",
  ...
  defaultFmt: [
    ...
    { text: "数値", value: "##0.00", example: "1000.12" },
    { text: "パーセンテージ", value: "#0.00%", example: "12.21%" },
    { text: "指数", value: "0.00E+00", example: "1.01E+5" },
    { text: "", value: "split", example: "" },
    { text: "通貨", value: "¥0.00", example: "¥1200.09" },
    { text: "", value: "split", example: "" },
    { text: "日付", value: "yyyy-MM-dd", example: "2017-11-29" },
    { text: "時刻", value: "hh:mm", example: "15:00" },
    { text: "日時", value: "yyyy-MM-dd hh:mm", example: "2017-11-29 15:00" },
    { text: "", value: "split", example: "" },
  ...
  border: {
    ...
    borderOutside: "外枠",
    borderInside: "内側",
    borderHorizontal: "内側水平線",
    borderVertical: "内側垂直線",
    borderColor: "罫線の色",
    borderSize: "罫線の種類",
  },
  merge: {
    ...
    mergeH: "横方向に結合",
    mergeCancel: "セル結合の解除",
    overlappingError: "重なる領域は結合できません。",
    partiallyError: "この操作は部分的に結合されたセルに対して実行できません。",
  },
  align: {
    left: "左揃え",
    center: "中央揃え",
  ...
  textWrap: { overflow: "はみ出す", wrap: "折り返す", clip: "切り取る" },
  rotation: {
    none: "回転なし",
    angleup: "右上がり",
    angledown: "右下がり",
  ...
  freezen: {
    ...
    rangeRCOverError: "ウィンドウ枠の固定領域が表示範囲を超えているため、意図しない動作をする可能性があります。",
  },
  sort: {
    asc: "昇順",
    desc: "降順",
  ...
  filter: {
    ...
    sortByAsc: "昇順で並べ替え A-Z",
    sortByDesc: "降順で並べ替え Z-A",
    filterByColor: "色フィルター",
    filterByCondition: "条件フィルター",
    filterByValues: "値フィルター",

    filiterInputNone: "なし",

    filiterInputTip: "値",
    filiterRangeStart: "",
    filiterRangeStartTip: "最小値",
    filiterRangeEnd: " - ",
    filiterRangeEndTip: "最大値",

    filterValueByAllBtn: "すべて選択",
    filterValueByClearBtn: "クリア",
    filterValueByInverseBtn: "反転",
    filterValueByTip: "値フィルター",
    filterConform: "適用",
    filterCancel: "キャンセル",
    clearFilter: "解除",

    conditionNone: "なし",
    conditionCellIsNull: "空のセル",
    conditionCellNotNull: "空でないセル",
    conditionCellTextContain: "指定の文字列を含む",
    conditionCellTextNotContain: "指定の文字列を含まない",
    conditionCellTextStart: "指定の文字列で始まる",
    conditionCellTextEnd: "指定の文字列で終わる",
    conditionCellTextEqual: "指定の文字列に一致する",
    conditionCellDateEqual: "指定の日付に一致する",
    conditionCellDateBefore: "指定の日付より前",
    conditionCellDateAfter: "指定の日付より後",
    conditionCellGreater: "指定の値より大きい",
    conditionCellGreaterEqual: "指定の値以上",
    conditionCellLess: "指定の値より小さい",
    conditionCellLessEqual: "指定の値以下",
    conditionCellEqual: "指定の値に一致する",
    conditionCellNotEqual: "指定の値に一致しない",
    conditionCellBetween: "指定の範囲内",
    conditionCellNotBetween: "指定の範囲外",

    filiterMoreDataTip: "お待ちください...",
    filiterMonthText: "月",
    filiterYearText: "年",
    filiterByColorTip: "塗りつぶしの色",
    filiterByTextColorTip: "フォントの色",
    filterContainerOneColorTip: "（この列のセルはすべて同じ色です）",
  ...
  rightclick: {
    ...
    chartGeneration: "グラフ作成",
    firstLineTitle: "（フィールド名： 先頭行）",
    untitled: "（フィールド名： 列識別子）",
    array1: "Json （一次元配列）",
    array2: "Json （二次元配列）",
    array3: "Json （多次元配列）",
    diagonal: "対角線 （左上から右下）",
    antiDiagonal: "対角線 （右上から左下）",
    diagonalOffset: "対角線 （左上から右下）列オフセット",
    offset: "オフセット",
    boolean: "Json （真偽値 二次元配列）",
    flip: "",
    upAndDown: "上下反転",
    leftAndRight: "左右反転",
    clockwise: "時計回り",
    ...
    log: "対数",
    delete0: "両端の 0 値の削除",
    removeDuplicate: "重複値の削除",
    byRow: "行ごと",
    byCol: "列ごと",
    generateNewMatrix: "新しい行列の生成",
  },
  comment: {
    insert: "挿入",
    edit: "編集",
  ...
  screenshot: {
    screenshotTipNoSelection: "スクリーンショットに含めるセル範囲を選択してください。",
    screenshotTipTitle: "警告",
    screenshotTipHasMerge: "この操作は結合されたセルに対して実行できません。",
    screenshotTipHasMulti: "この操作は複数の選択範囲に対して実行できません。",
    screenshotTipSuccess: "スクリーンショット",
    screenshotImageName: "sheet",

    downLoadClose: "閉じる",
    downLoadCopy: "クリップボードへ送る",
    downLoadBtn: "ダウンロード",
    browserNotTip: "IE はサポートされていません！",
    rightclickTip: '画像を右クリックしてコピーしてください。',
    successTip: 'コピーしました（貼り付けに失敗する場合は画像を右クリックして「画像をコピー」してください）',
  },
  splitText: {
    splitDelimiters: "区切り文字",
    splitOther: "その他",
    splitContinueSymbol: "連続した区切り文字を単一の区切りとして扱う",
    splitDataPreview: "プレビュー",
    splitTextTitle: "テキスト分割",
    splitConfirmToExe: "すでにデータが存在します。置き換えますか？",

    tipNoMulti: "この操作は複数の選択範囲に対して実行できません。",
    tipNoMultiColumn: "この操作は複数列にまたがるセル範囲に対して実行できません（複数行は可）。",
  },
  imageText: {
    imageSetting: "画像設定",
    close: "閉じる",
    conventional: "位置関係",
    moveCell1: "セルに合わせて移動やサイズ変更をする",
    moveCell2: "セルに合わせて移動するがサイズ変更はしない",
    moveCell3: "せるに合わせて移動やサイズ変更をしない",
    fixedPos: "スクロールに追従",
    border: "輪郭",
    width: "太さ",
    radius: "角丸半径",
  ...
  findAndReplace: {
    ...
    columnSpan: "1 列置き",
    locationExample: "",
    lessTwoRowTip: "2 行以上選択してください。",
    lessTwoColumnTip: "2 列以上選択してください。",

    findTextbox: "検索する文字列",
    replaceTextbox: "置換後の文字列",

    regexTextbox: "正規表現",
    wholeTextbox: "セル内容が完全に同一であるものを検索する",
    distinguishTextbox: "大文字と小文字を区別する",
    ...
    noFindTip: "見つかりませんでした。",
    modeTip: "読み取り専用のため利用できません。",

    searchTargetSheet: "シート",
    searchTargetCell: "セル",
    searchTargetValue: "値",

    searchInputTip: "検索する文字列を入力してください。",

    noReplceTip: "見つかりませんでした。",
    noMatchTip: "見つかりませんでした。",
    ...
    locationRowSpan: "1 行置き",
    locationColumnSpan: "1 列置き",

    locationTiplessTwoRow: "2 行以上選択してください。",
    locationTiplessTwoColumn: "2 列以上選択してください。",
    locationTipNotFindCell: "見つかりませんでした。",
  },
  sheetconfig: {
    delete: "削除",
    copy: "コピー",
  ...
  insertLink: {
    ...
    placeholder2: "例: A1",
    placeholder3: "",
    tooltipInfo1: "有効な URL を入力してください。",
    tooltipInfo2: "有効なセル参照を入力してください。",
  },
  dataVerification: {
    cellRange: "セル範囲",
    selectCellRange: "セル範囲を選択してください",
    selectCellRange2: "セル範囲を選択してください",
    verificationCondition: "入力規則",
    allowMultiSelect: "複数選択",
    dropdown: "リスト",
    checkbox: "チェックボックス",
    number: "数値",
    number_integer: "整数値",
    ...
    placeholder3: "",
    placeholder4: "",
    placeholder5: "セル選択時に表示するメッセージ",
    selected: "選択",
    notSelected: "未選択",
    between: "指定の範囲内",
    notBetween: "指定の範囲外",
    equal: "指定の値に一致する",
    notEqualTo: "指定の値に一致しない",
    moreThanThe: "指定の値より大きい",
    lessThan: "指定の値より小さい",
    greaterOrEqualTo: "指定の値以上",
    lessThanOrEqualTo: "指定の値以下",
    include: "指定の文字列を含む",
    exclude: "指定の文字列を含まない",
    earlierThan: "指定の日付より前",
    noEarlierThan: "指定の日付以降",
    laterThan: "指定の日付より後",
    noLaterThan: "指定の日付以前",
    identificationNumber: "", // 中国の国民識別番号
    phoneNumber: "",          // 中国の電話番号（"1" で始まる）
    remote: "自動リモート取得",
    prohibitInput: "不正な値の入力を防ぐ",
    hintShow: "セル選択時にメッセージを表示する",
    deleteVerification: "入力規則削除",
    tooltipInfo1: "候補値リストを入力してください。",
    tooltipInfo2: "チェックボックスの内容を入力してください。",
    tooltipInfo3: "数値を入力してください。",
    tooltipInfo4: "左の値より右の値の方が大きくなるようにしてください。",
    tooltipInfo5: "文字列を入力してください。",
    tooltipInfo6: "日付を入力してください。",
    tooltipInfo7: "左の日付より右の日付の方が未来になるようにしてください。",
    textlengthInteger: "文字列の長さには 0 以上の数値を入力してください。",
  },
  formula: {
    sum: "合計",
    average: "平均",
    ...
    tipNotBelongToIf: "IF 関数でない式が入力されています。",
    tipSelectCell: "関数を挿入するセルを選択してください。",

    ifGenCompareValueTitle: "比較対象",
    ifGenSelectCellTitle: "セル選択",
    ifGenRangeTitle: "値の範囲",
    ifGenRangeTo: " - ",
    ifGenRangeEvaluate: "セル範囲の評価",
    ifGenSelectRangeTitle: "セル範囲選択",
    ifGenCutWay: "分割方法",
    ifGenCutSame: "N ごとに分割",
    ifGenCutNpiece: "N 個に分割",
    ifGenCutCustom: "カスタム",
    ifGenCutConfirm: "Confirm",

    ifGenTipSelectCell: "セル選択",
    ifGenTipSelectCellPlace: "",

    ifGenTipSelectRange: "セル範囲選択",
    ifGenTipSelectRangePlace: "",

    ifGenTipNotNullValue: "比較対象を入力してください。",
    ifGenTipLableTitile: "ラベル",
    ifGenTipRangeNotforNull: "値の範囲を入力してください。",
    ifGenTipCutValueNotforNull: "分割値を入力してください。",
    ifGenTipNotGenCondition: "条件がありません。",
  },
  formulaMore: {
    valueTitle: "値",
    tipSelectDataRange: "セル範囲選択",
    tipDataRangeTile: "セル範囲",
    findFunctionTitle: "関数検索",
    tipInputFunctionName: "関数名または関数の説明",
    ...
    selectFunctionTitle: "関数を選択してください",
    calculationResult: "計算結果",

    tipSuccessText: "成功",
    tipParamErrorText: "パラメーター型エラー",
    ...
    execfunctionError: "式にエラーがあります。",
    execfunctionSelfError: "式は参照元セル自身を参照できません。",
    execfunctionSelfErrorResult: "式は参照元セル自身を参照できません。",

    allowRepeatText: "繰り返し可",
    allowOptionText: "省略可",

    selectCategory: "カテゴリ",
  },
  drag: {
    noMerge: "この操作は結合セルに対して実行できません。",
    affectPivot: "ピボットテーブルに影響があるため変更できません。",
    noMulti: "この操作は複数の選択範囲に対して実行できません。",
    noPaste: "ここには貼り付けられませんでした。",
    noPartMerge: "この操作は部分的に結合されたセルに対して実行できません。",

    inputCorrect: "正しい値を入力してください。",
    notLessOne: "行数と列数には 1 以上の数値を入力してください。",
    offsetColumnLessZero: "列オフセットには 0 以上の数値を入力してください。",

    pasteMustKeybordAlert: "コピー: Ctrl + C, 貼り付け: Ctrl + V, 切り取り: Ctrl + X",
    pasteMustKeybordAlertHTMLTitle: "コピー・貼り付け",
    pasteMustKeybordAlertHTML: "<span style='line-height: 1.0;font-size:24px;font-weight: bold;color:#666;'>Ctrl + C</span>&nbsp;&nbsp;コピー<br/><span style='line-height: 1.0;font-size:24px;font-weight: bold;color:#666;'>Ctrl + V</span>&nbsp;&nbsp;貼り付け<br/><span style='line-height: 1.0;font-size:24px;font-weight: bold;color:#666;'>Ctrl + X</span>&nbsp;&nbsp;切り取り",
  },
  paste: {
    warning: "警告",
    errorNotAllowMulti: "この操作は複数の選択範囲に対して実行できません。",
    errorNotAllowMerged: "結合セルの一部を変更することはできません。",
  },
  // todo
  pivotTable: {
    title: "Pivot Table",
